...
class AudioSurhas {
    ...
    AudioSurhas({this.code, this.status, this.data});

    AudioSurhas.fromJson(Map<String, dynamic> json) {
        code = json["code"];
        status = json["status"];
...
class Ayahs {
    ...
    Ayahs({this.number, this.audio, this.audioSecondary, this.text, this.numberInSurah, this.juz, this.manzil, this.page, this.ruku, this.hizbQuarter, this.sajda});

    Ayahs.fromJson(Map<String, dynamic> json) {
        number = json["number"];
        audio = json["audio"];
        audioSecondary = json["audioSecondary"] == null ? null : List<String>.from(json["audioSecondary"]);
        text = json["text"];
